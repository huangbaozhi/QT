...
//初始化PA8
//PWM_duoji(1000, 1440, 75);//2.5ms---90度
...
//舵机控制
//Duoji_Control(OFF);		
//TIM_SetCompare1(TIM1,30);//占空比3%,最右边，0度
//Duoji_Control(ON);	
//	
//Duoji_Control(OFF);		
//TIM_SetCompare1(TIM1,50);//占空比5%，45度
//Duoji_Control(ON);	

//Duoji_Control(OFF);		
//TIM_SetCompare1(TIM1,75);//占空比5%，90度
//Duoji_Control(ON);

//Duoji_Control(OFF);		
//TIM_SetCompare1(TIM1,100);//占空比5%，135度
//Duoji_Control(ON);

//Duoji_Control(OFF);		
//TIM_SetCompare1(TIM1,125);//占空比12.5%，最左边180度
//Duoji_Control(ON);	
